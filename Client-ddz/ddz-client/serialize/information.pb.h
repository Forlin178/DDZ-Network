...
class Information final :
 ...
 public:
  ...
  enum : int {
    ...
    kData2FieldNumber = 4,
    kData3FieldNumber = 5,
    kRequestCodeFieldNumber = 6,
    kResponseCodeFieldNumber = 7,
  };
  // string userName = 1;
  void clear_username();
  ...
  void set_responsecode(::ResponseCode value);
  private:
  ::ResponseCode _internal_responsecode() const;
  void _internal_set_responsecode(::ResponseCode value);
  public:
...
// .RequestCode requestCode = 6;
inline void Information::clear_requestcode() {
  _impl_.requestcode_ = 0;
}
inline ::RequestCode Information::_internal_requestcode() const {
  return static_cast< ::RequestCode >(_impl_.requestcode_);
}
inline ::RequestCode Information::requestcode() const {
  // @@protoc_insertion_point(field_get:Information.requestCode)
  return _internal_requestcode();
}
inline void Information::_internal_set_requestcode(::RequestCode value) {
  
  _impl_.requestcode_ = value;
}
inline void Information::set_requestcode(::RequestCode value) {
  _internal_set_requestcode(value);
  // @@protoc_insertion_point(field_set:Information.requestCode)
}

// .ResponseCode responseCode = 7;
inline void Information::clear_responsecode() {
  _impl_.responsecode_ = 0;
}
inline ::ResponseCode Information::_internal_responsecode() const {
  return static_cast< ::ResponseCode >(_impl_.responsecode_);
}
inline ::ResponseCode Information::responsecode() const {
  // @@protoc_insertion_point(field_get:Information.responseCode)
  return _internal_responsecode();
}
inline void Information::_internal_set_responsecode(::ResponseCode value) {
  
  _impl_.responsecode_ = value;
}
inline void Information::set_responsecode(::ResponseCode value) {
  _internal_set_responsecode(value);
  // @@protoc_insertion_point(field_set:Information.responseCode)
}
