...
PROTOBUF_CONSTEXPR Information::Information(
  ...
  , /*decltype(_impl_.requestcode_)*/0
...
const uint32_t TableStruct_information_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Information, _impl_.requestcode_),
  PROTOBUF_FIELD_OFFSET(::Information, _impl_.responsecode_),
};
...
const char descriptor_table_protodef_information_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\021\n\rOtherGrabLoad\020\010\022\021\n\rOtherPlayHand\020\t\022\022\n"
...
const ::_pbi::DescriptorTable descriptor_table_information_2eproto = {
    false, false, 597, descriptor_table_protodef_information_2eproto,
    "information.proto",
...
Information::Information(const Information& from)
  ...
  ::memcpy(&_impl_.requestcode_, &from._impl_.requestcode_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.responsecode_) -
    reinterpret_cast<char*>(&_impl_.requestcode_)) + sizeof(_impl_.responsecode_));
...
// @@protoc_insertion_point(message_clear_start:Information)
  ...
  ::memset(&_impl_.requestcode_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.responsecode_) -
      reinterpret_cast<char*>(&_impl_.requestcode_)) + sizeof(_impl_.responsecode_));
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_responsecode(static_cast<::ResponseCode>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Information::_InternalSerialize(
  ...
  // .RequestCode requestCode = 6;
  if (this->_internal_requestcode() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      6, this->_internal_requestcode(), target);
  }

  // .ResponseCode responseCode = 7;
  if (this->_internal_responsecode() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      7, this->_internal_responsecode(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Information)
  ...
  if (this->_internal_requestcode() != 0) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_requestcode());
  }

  // .ResponseCode responseCode = 7;
  if (this->_internal_responsecode() != 0) {
    total_size += 1 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_responsecode());
  }
...
void Information::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_requestcode() != 0) {
    _this->_internal_set_requestcode(from._internal_requestcode());
  }
  if (from._internal_responsecode() != 0) {
...
void Information::InternalSwap(Information* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Information, _impl_.responsecode_)
      + sizeof(Information::_impl_.responsecode_)
      - PROTOBUF_FIELD_OFFSET(Information, _impl_.requestcode_)>(
          reinterpret_cast<char*>(&_impl_.requestcode_),
          reinterpret_cast<char*>(&other->_impl_.requestcode_));
}
